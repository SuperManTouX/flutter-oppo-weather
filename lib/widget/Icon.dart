...
class QIcon extends StatelessWidget {
  ...
  const QIcon({super.key, required this.iconCode, this.size = 60});
...
class NetIcon extends StatelessWidget {
  ...
  const NetIcon({super.key, required this.name, this.size = 60});

  @override
  Widget build(BuildContext context) {
    // 拼接和风天气CDN图标地址（svg格式）
    String iconUrl = 'assets/NetIcon/$name.svg';
